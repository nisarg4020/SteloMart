...
<option value="physical_product" selected> Physical Products  </option>

<option value="digital_product"> Electronics Products </option>

<?php }elseif($p_type == "digital_product"){ ?>

<option value="physical_product"> Physical Products </option>

<option value="digital_product" selected> Electronics Products </option>
