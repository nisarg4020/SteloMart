...
<option value="physical_product" selected> Physical Product </option>

<option value="digital_product"> Electronics Product </option>

<?php }elseif($p_type == "digital_product"){ ?>

<option value="physical_product"> Physical Product </option>

<option value="digital_product" selected> Electronics Product </option>
